...
<div align="center">
<?
	 echo"<img src='".$imgs.$fimgs."b18.gif' width='75' height='100'><br />";
 echo"<table width='650'><tr><td> ".$buildings[3][8]."</td></tr></table>";
?>
...
if ($data[3])
{
 ...
 for ($i=0; $i<1; $i++)
		...
		echo "<a class='q_link' target='_parent' href='build.php?town=".$town[0]."&b=".$buildings[3][0]."&subB=".$i."'>".$lang['upgrade']." ".$name[1]." ".$lang['toLevel']." ".($land[$i]+1)."</a>";
