    ...
    $res[3]+=$pro[3]+1000;
	 $res[4]+=$pro[4]+1000;
      ...
      $resources=$res[0].'-'.$res[1].'-'.$res[2].'-'.$res[3].'-'.$res[4];
        ...
        $msx='<font color="#FF0000">Ресурсы зачислены</font>';

    }else{

        $msx='Вам не хватает бонусов.Приобретите их!!';
...
<table width="650"><tr><td>
        <ul id='tabs'>
            <li><a href='#buyres'>Получить Бонус</a></li>
            <li><a href='#buycoins'>Купить кредиты</a></li>
        </ul>
        </td></tr></table>
        <div class='tabContent' id='buyres'>
                <div>
               <font  color="#FF0000"> <? echo $msx;?></font><br />
             У вас : <b><?php echo $usr[7]; ?></b> кредитов<br>
         <table class="q_table" style="border-collapse: collapse" width="650" border="1">
            ...
            <tr>
             ...
             <td>2</td>
             <td><a class='q_link' href='prem.php?town=<?php echo $_GET['town']; ?>&bonus=1k'>Получить</a></td>
            </tr>
            <tr>
             ...
             <td>9</td>
             <td><a class='q_link' href='prem.php?town=<?php echo $_GET['town'];?>&bonus=5k'>Получить</a></td>
            </tr>
               <tr>
             ...
             <td>17</td>
             <td><a class='q_link' href='prem.php?town=<?php echo $_GET['town'];?>&bonus=10k'>Получить</a></td>
            </tr>
               <tr>
             ...
             <td>60</td>
             <td><a class='q_link' href='prem.php?town=<?php echo $_GET['town'];?>&bonus=50k'>Получить</a></td>
            </tr>
               <tr>
             ...
             <td>100</td>
             <td><a class='q_link' href='prem.php?town=<?php echo $_GET['town'];?>&bonus=100k'>Получить</a></td>
            </tr>
            </table>
</div>
</div>
...
<table width='650'>
                <tr> 
<h3>Как получить кредиты?</h3>
Вам надо написать нам в:<br>
<img src="./template/index/skype-icon.gif" /> Skype: <a href="skype:dobrjag?chat" ><b>dobrjag</b></a><br>
<img src="./template/index/icq.gif" /> ICQ: <b>565519317</b>
