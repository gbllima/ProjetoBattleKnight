...
<?php
 ...
 for ($i=0; (($i<$id+10)&&($i<count($town_stats))); $i++) echo "<tr><td>".($i+1)."</td><td><a class='q_link' href='profile_view.php?id=".$town_stats[$i][1]."'>".stripslashes($town_stats[$i][2])."</a></td><td>".$town_stats[$i][$val]."</td></tr>";
?>
        </table>
