...
<div align="center">
<? 
		 echo"	<img src='".$imgs.$fimgs."b11.gif' width='75' height='100'><br />";
 echo"<table width='650'><tr><td> ".$buildings[11][8]."</td></tr></table>";
?>
