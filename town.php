...
<head>
<body class="q_body">
<?php include("include/town/header1.php");?>
<iframe name="main" src="tow.php?town=<?php echo $townId; ?>" width="650" height="575" frameborder="0" framespacing="0" marginwidth="0" marginheight="0" framepadding="0" scrolling="no"></iframe> 
<?php include("include/town/footer.php");?>