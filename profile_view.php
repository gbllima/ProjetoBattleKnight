...
<div align="center">
	    ...
	    {
	     echo "<tr><td align='center'>".$lang['sitter']."</td><td align='left'><input class='textbox' type='text' name='sitter'  value='".$usr[12]."'></td></tr><tr><td align='center'>".$lang['graphPackPath']."</td><td align='left'><input class='textbox' type='text' name='grpath' disabled value='".$usr[13]."'></td></tr><tr><td align='center'>".$lang['language']."</td><td align='left'>
