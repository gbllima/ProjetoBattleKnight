...
<img src="../../template/town/workers.png" alt="Population" class="small_pic"/>
<font class="text">
...
<img src="../../template/town/wood.gif" alt="<?php echo $lang['wood'] ?>" class="small_pic"/>
<font class="text">
...
<img src="../../template/town/food.gif" alt="<?php echo $lang['food'] ?>" class="small_pic"/>
<font class="text">
...
<img src="../../template/town/gold.gif" alt="<?php echo $lang['gold'] ?>" class="small_pic"/>
<font class="text">
...
<img src="../../template/town/stone.gif" alt="<?php echo $lang['stone'] ?>" class="small_pic"/>
<font class="text">
...
<img src="../../template/town/iron.gif" alt="<?php echo $lang['iron'] ?>" class="small_pic"/>
<font class="text">
...
<div class="inline_title" style="position:relative;top:68px;left:80px;font-weight:bold;font-size:13px;width:200px;">
</div>
<div class="back_flag" style="position:relative;left:562px;top:-63px;font-size:11px;color:#AD7734;">
<div style="position:absolute;top:40px;" align="center">
<img src="../../template/town/map.png" alt="world link" border="0"/><br />
<?php echo $lang['showmap'] ?>
</div>
<div style="position:absolute;top:40px;" align="center">
<img src="../../template/town/msg.png" alt="msg link" border="0"/><br />
<?php echo $lang['showcw'] ?>
</div>
<div style="position:absolute;top:40px;" align="center">
<img src="../../template/town/th.png" alt="town link" border="0"/><br />
<?php echo $lang['showtwn'] ?>				
</div>
</div>
</div>
...
<div class="left_flag">
<font style="position:relative;top:6px;left:120px;font-weight:bold;font-size:13px;">Navigation</font>
</div>
<br />
<? include("dropmen1.php");?>
</div>
</td>
